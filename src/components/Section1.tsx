      ...
      <div className="relative z-10 px-6">
        <div className="relative w-full h-[600px] rounded-[2rem] overflow-hidden shadow-2xl bg-white/10 backdrop-blur-sm">
          ...
          <div className="absolute bottom-10 left-10">
            ...
            <button className="bg-accent-orange hover:bg-orange-500 transition-colors text-white font-sans text-xs uppercase tracking-widest py-4 px-8 rounded-full shadow-lg">
